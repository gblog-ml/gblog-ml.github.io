...
You might have noticed, this actually has a flavour similar to Generative Adversarial Networks (GANs).
...
[^1]: Technically, the empirical version of the KL divergence above differs from the objective (see Equation (8) in Gutmann and Hyvärinen).